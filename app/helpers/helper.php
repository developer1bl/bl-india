...
if (! function_exists('getTimeZoneByCountryName')){
    function getTimeZoneByCountryName($countryCode) {

        //get the country based on the country code
        $country = Countries::where('phonecode', $countryCode)->first();
        $iso = $country->iso;
        ...
        return $countryTimezones[$iso] ?? 'UTC'; // Default to UTC if country code not found
    }
}
